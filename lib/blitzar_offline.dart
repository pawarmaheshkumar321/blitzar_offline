...
Widget ui_textfield(double textFieldwidth, double textFieldheight, TextEditingController _textf_contro_batmanvalue, String label, String hint){
  return new Column(
    children: [
      new Row(
